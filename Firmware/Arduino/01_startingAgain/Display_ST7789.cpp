...
#define MADCTL_BGR 0x08  // BGR color order (some panels need this)
...
void LCD_Init(void)
{
  ...
  if (HORIZONTAL)
      //LCD_WriteData(0x00); //original line
      // Landscape mode
      LCD_WriteData(MADCTL_MV | MADCTL_MY | MADCTL_RGB); //chatGPT line
  else
      //LCD_WriteData(0x70); //original line
      // Portrait mode
      LCD_WriteData(MADCTL_MX | MADCTL_MY | MADCTL_RGB); //chatGPT line
